...
// import bg from "./../../../../public/assets/background/bg.gif";
...
const FeaturesSection = () => {
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center lg:items-start lg:justify-between gap-12 w-full">
        <h2 className="text-[24px] lg:text-6xl font-bold text-center lg:text-left lg:w-1/2">
          What
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BA24D5] to-[#EA83FF]">
            {" "}Drives
          </span>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-12 lg:w-1/2">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-[16px] lg:text-2xl text-[#333333] font-[600] text-center lg:text-left">
                {feature.title}
              </h3>

              <p className="text-[12px] text-[#333333] lg:text-lg text-center lg:text-left">
                {feature.description}
              </p>
            </div>
          ))}
