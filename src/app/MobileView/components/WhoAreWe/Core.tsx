...
const coreValues = [
  {
    ...
    img: "/assets/WhoAreWe/CoreImg1.svg",
    title: "Innovation First",
    description:
      "We push boundaries, creating cutting-edge blockchain solutions that drive progress.",
  },
  {
    // Use absolute string paths starting from the root '/'
    img: "/assets/WhoAreWe/CoreImg2.svg",
    title: "Grow Together",
    description:
      "We believe in teamwork, continuous learning, and evolving with the industry.",
  },
  {
    // Use absolute string paths starting from the root '/'
    img: "/assets/WhoAreWe/CoreImg3.svg",
    title: "User-Centric Approach",
    description:
      "We design with people in mind, making blockchain technology accessible and seamless.",
  },
          ...
          {coreValues.map((value, index) => (
            ...
            >
              ...
              <Image
                src={value.img}
                alt={value.title}
                width={200} // Ensure these dimensions are appropriate
                height={200} // Ensure these dimensions are appropriate
                className="mb-6"
              />
              <h3 className="text-2xl font-semibold mb-4">{value.title}</h3>
              <p className="text-gray-700">{value.description}</p>
