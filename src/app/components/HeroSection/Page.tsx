  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 py-16">
        ...
        <div className="md:w-1/2 mt-8 md:mt-5 relative">
          ...
          <Image
            ...
            width={500}
            height={500}
            className="mx-auto relative z-10 hidden md:block"
          />
        </div>
      </div>
      ...
      <section className="relative flex flex-col items-center justify-center px-6 pt-16 pb-12 hidden md:flex">
        <div
          className="relative z-10 w-full max-w-7xl flex justify-around items-center 
                      rounded-full  bg-white 
                      before:absolute before:inset-0 before:rounded-full 
                      before:bg-gradient-to-r before:from-purple-100 before:via-purple-400 before:to-pink-100 
                      before:-z-10 before:m-[-3px] before:p-[3px] before:content-['']"
        >
          <div className="relative w-full h-full rounded-full bg-white flex justify-around items-center p-6">
            <div className="text-center">
              <h2 className="text-2xl font-semibold">
                30<span className="text-gray-600">+ Projects</span>
              </h2>
            </div>
            <div className="text-center">
              <h2 className="text-2xl font-semibold">
                40<span className="text-gray-600">+ Developers</span>
              </h2>
            </div>
            <div className="text-center">
              <h2 className="text-2xl font-semibold">
                10<span className="text-gray-600">+ Ecosystems</span>
              </h2>
            </div>
          </div>
        </div>
